...
import { Save, Download, Upload, Undo, Redo, Sun, Moon, Play, Edit3, Palette, Code, FileText } from 'lucide-react';
    ...
    <header className={`border-b transition-colors duration-200 ${
      ...
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            {currentSlide?.contentMode === 'html' ? <Code className="w-4 h-4" /> : <FileText className="w-4 h-4" />}
          </button>
