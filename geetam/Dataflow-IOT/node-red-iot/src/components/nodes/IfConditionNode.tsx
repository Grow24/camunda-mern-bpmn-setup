...
import { GitBranch, Activity, GripVertical, Settings, Play, Trash2 } from 'lucide-react';
import clsx from 'clsx';

export function IfConditionNode({ data, selected }: NodeProps) {
