...
import { Bug, Activity, GripVertical, Settings, Play, Trash2 } from 'lucide-react';
...
export function DebugNode({ data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      {data.output && (
        <div className="mt-2 text-xs font-mono text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 rounded px-2 py-1 max-h-20 overflow-y-auto">
          {JSON.stringify(data.output, null, 1)}
        </div>
      )}
